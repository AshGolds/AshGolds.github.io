...
CREATE SCHEMA IF NOT EXISTS google_fit_v_7;
SET SCHEMA 'google_fit_v_7';
...
drop table if exists coaching_plan cascade;
...
CREATE TABLE health_log (
    ...
    CONSTRAINT health_log_fkey_device 
        FOREIGN KEY (device_id, sequence_number)  
...
CREATE TABLE goal (
    ...
    google_id VARCHAR(300) NOT NULL,
    move_minute_goal DECIMAL,
    step_goal DECIMAL,
    heart_point_goal DECIMAL,
...
INSERT INTO device (device_id, google_id, location, sequence_number) VALUES
('device001', 'user001', POINT(37.7749, -122.4194), 1),
('device002', 'user002', POINT(34.0522, -118.2437), 1),
('device003', 'user003', POINT(40.7128, -74.0060), 1),
('device004', 'user004', POINT(51.5074, -0.1278), 1),
('device005', 'user005', POINT(48.8566, 2.3522), 1),
('device006', 'user006', POINT(35.6895, 139.6917), 1),
('device007', 'user007', POINT(55.7558, 37.6173), 1),
('device008', 'user008', POINT(39.9042, 116.4074), 1),
('device009', 'user009', POINT(-33.8688, 151.2093), 1),
('device010', 'user010', POINT(-34.6037, -58.3816), 1),
('device011', 'user011', POINT(37.7749, -122.4194), 1),
('device012', 'user012', POINT(34.0522, -118.2437), 1),
('device013', 'user013', POINT(40.7128, -74.0060), 1),
('device014', 'user014', POINT(51.5074, -0.1278), 1),
('device015', 'user015', POINT(48.8566, 2.3522), 1),
('device016', 'user016', POINT(35.6895, 139.6917), 1),
('device017', 'user017', POINT(55.7558, 37.6173), 1),
('device018', 'user018', POINT(39.9042, 116.4074), 1),
('device019', 'user019', POINT(-33.8688, 151.2093), 1),
('device020', 'user020', POINT(-34.6037, -58.3816), 1);
...
('log001', 'user001', 'device001', 1, '2024-01-01 22:00:00', 'Sleep'),
('log002', 'user002', 'device002', 1, '2024-01-02 21:30:00', 'Sleep'),
('log003', 'user003', 'device003', 1, '2024-01-03 23:00:00', 'Sleep'),
('log004', 'user004', 'device004', 1, '2024-01-04 20:30:00', 'Sleep'),
('log005', 'user005', 'device005', 1, '2024-01-05 21:00:00', 'Sleep'),
('log006', 'user006', 'device006', 1, '2024-01-06 22:30:00', 'Sleep'),
('log007', 'user007', 'device007', 1, '2024-01-07 23:15:00', 'Sleep'),
('log008', 'user008', 'device008', 1, '2024-01-08 20:45:00', 'Sleep'),
('log009', 'user009', 'device009', 1, '2024-01-09 22:00:00', 'Sleep'),
('log010', 'user010', 'device010', 1, '2024-01-10 21:00:00', 'Sleep'),
('log011', 'user011', 'device011', 1, '2024-01-11 22:15:00', 'Sleep'),
('log012', 'user012', 'device012', 1, '2024-01-12 21:45:00', 'Sleep'),
('log013', 'user013', 'device013', 1, '2024-01-13 23:30:00', 'Sleep'),
('log014', 'user014', 'device014', 1, '2024-01-14 20:00:00', 'Sleep'),
('log015', 'user015', 'device015', 1, '2024-01-15 22:45:00', 'Sleep'),
('log016', 'user016', 'device016', 1, '2024-01-16 21:15:00', 'Sleep'),
('log017', 'user017', 'device017', 1, '2024-01-17 20:30:00', 'Sleep'),
('log018', 'user018', 'device018', 1, '2024-01-18 23:00:00', 'Sleep'),
('log019', 'user019', 'device019', 1, '2024-01-19 22:00:00', 'Sleep'),
('log020', 'user020', 'device020', 1, '2024-01-20 21:30:00', 'Sleep');
...
INSERT INTO health_log (health_log_id, google_id, device_id, sequence_number, time_stamp, log_type) VALUES
('log201', 'user001', 'device011', 1, '2024-01-01 22:00:00', 'Cycle'),  -- Alice
('log202', 'user004', 'device012', 1, '2024-01-04 20:30:00', 'Cycle'),  -- Diana
('log203', 'user006', 'device013', 1, '2024-01-06 22:30:00', 'Cycle'),  -- Fiona
('log204', 'user008', 'device014', 1, '2024-01-08 21:15:00', 'Cycle'),  -- Hannah
('log205', 'user010', 'device015', 1, '2024-01-10 21:00:00', 'Cycle'),  -- Jessica
('log206', 'user012', 'device016', 1, '2024-01-12 22:15:00', 'Cycle'),  -- Laura
('log207', 'user014', 'device017', 1, '2024-01-14 21:45:00', 'Cycle'),  -- Nina
('log208', 'user016', 'device018', 1, '2024-01-16 22:00:00', 'Cycle'),  -- Pamela
('log209', 'user018', 'device019', 1, '2024-01-18 21:30:00', 'Cycle'),  -- Rachel
('log210', 'user020', 'device020', 1, '2024-01-20 21:00:00', 'Cycle');  -- Tina
...
INSERT INTO health_log (health_log_id, google_id, device_id, sequence_number, time_stamp, log_type) VALUES
('log301', 'user001', 'device001', 1, '2024-10-01 22:00:00', 'Body Measurement'),
('log302', 'user002', 'device002', 1, '2024-10-02 22:15:00', 'Body Measurement'),
('log303', 'user003', 'device003', 1, '2024-10-03 22:30:00', 'Body Measurement'),
('log304', 'user004', 'device004', 1, '2024-10-04 22:45:00', 'Body Measurement'),
('log305', 'user005', 'device005', 1, '2024-10-05 23:00:00', 'Body Measurement'),
('log306', 'user006', 'device006', 1, '2024-10-06 23:15:00', 'Body Measurement'),
('log307', 'user007', 'device007', 1, '2024-10-07 23:30:00', 'Body Measurement'),
('log308', 'user008', 'device008', 1, '2024-10-08 23:45:00', 'Body Measurement'),
('log309', 'user009', 'device009', 1, '2024-10-09 21:00:00', 'Body Measurement'),
('log310', 'user010', 'device010', 1, '2024-10-10 21:15:00', 'Body Measurement'),
('log311', 'user011', 'device011', 1, '2024-10-11 21:30:00', 'Body Measurement'),
('log312', 'user012', 'device012', 1, '2024-10-12 21:45:00', 'Body Measurement'),
('log313', 'user013', 'device013', 1, '2024-10-13 22:00:00', 'Body Measurement'),
('log314', 'user014', 'device014', 1, '2024-10-14 22:15:00', 'Body Measurement'),
('log315', 'user015', 'device015', 1, '2024-10-15 22:30:00', 'Body Measurement'),
('log316', 'user016', 'device016', 1, '2024-10-16 22:45:00', 'Body Measurement'),
('log317', 'user017', 'device017', 1, '2024-10-17 23:00:00', 'Body Measurement'),
('log318', 'user018', 'device018', 1, '2024-10-18 23:15:00', 'Body Measurement'),
('log319', 'user019', 'device019', 1, '2024-10-19 23:30:00', 'Body Measurement'),
('log320', 'user020', 'device020', 1, '2024-10-20 23:45:00', 'Body Measurement');
...
INSERT INTO health_log (health_log_id, google_id, device_id, sequence_number, time_stamp, log_type) VALUES
('log401', 'user001', 'device001', 1, '2024-10-01 12:00:00', 'Nutrition'),
('log402', 'user002', 'device002', 1, '2024-10-02 12:15:00', 'Nutrition'),
('log403', 'user003', 'device003', 1, '2024-10-03 12:30:00', 'Nutrition'),
('log404', 'user004', 'device004', 1, '2024-10-04 12:45:00', 'Nutrition'),
('log405', 'user005', 'device005', 1, '2024-10-05 13:00:00', 'Nutrition'),
('log406', 'user006', 'device006', 1, '2024-10-06 13:15:00', 'Nutrition'),
('log407', 'user007', 'device007', 1, '2024-10-07 13:30:00', 'Nutrition'),
('log408', 'user008', 'device008', 1, '2024-10-08 13:45:00', 'Nutrition'),
('log409', 'user009', 'device009', 1, '2024-10-09 14:00:00', 'Nutrition'),
('log410', 'user010', 'device010', 1, '2024-10-10 14:15:00', 'Nutrition'),
('log411', 'user011', 'device011', 1, '2024-10-11 14:30:00', 'Nutrition'),
('log412', 'user012', 'device012', 1, '2024-10-12 14:45:00', 'Nutrition'),
('log413', 'user013', 'device013', 1, '2024-10-13 15:00:00', 'Nutrition'),
('log414', 'user014', 'device014', 1, '2024-10-14 15:15:00', 'Nutrition'),
('log415', 'user015', 'device015', 1, '2024-10-15 15:30:00', 'Nutrition'),
('log416', 'user016', 'device016', 1, '2024-10-16 15:45:00', 'Nutrition'),
('log417', 'user017', 'device017', 1, '2024-10-17 16:00:00', 'Nutrition'),
('log418', 'user018', 'device018', 1, '2024-10-18 16:15:00', 'Nutrition'),
('log419', 'user019', 'device019', 1, '2024-10-19 16:30:00', 'Nutrition'),
('log420', 'user020', 'device020', 1, '2024-10-20 16:45:00', 'Nutrition');
...
INSERT INTO health_log (health_log_id, google_id, device_id, sequence_number, time_stamp, log_type) VALUES
('log501', 'user001', 'device001', 1, '2024-10-01 08:00:00', 'Vital'),
('log502', 'user002', 'device002', 1, '2024-10-02 08:15:00', 'Vital'),
('log503', 'user003', 'device003', 1, '2024-10-03 08:30:00', 'Vital'),
('log504', 'user004', 'device004', 1, '2024-10-04 08:45:00', 'Vital'),
('log505', 'user005', 'device005', 1, '2024-10-05 09:00:00', 'Vital'),
('log506', 'user006', 'device006', 1, '2024-10-06 09:15:00', 'Vital'),
('log507', 'user007', 'device007', 1, '2024-10-07 09:30:00', 'Vital'),
('log508', 'user008', 'device008', 1, '2024-10-08 09:45:00', 'Vital'),
('log509', 'user009', 'device009', 1, '2024-10-09 10:00:00', 'Vital'),
('log510', 'user010', 'device010', 1, '2024-10-10 10:15:00', 'Vital'),
('log511', 'user011', 'device011', 1, '2024-10-11 10:30:00', 'Vital'),
('log512', 'user012', 'device012', 1, '2024-10-12 10:45:00', 'Vital'),
('log513', 'user013', 'device013', 1, '2024-10-13 11:00:00', 'Vital'),
('log514', 'user014', 'device014', 1, '2024-10-14 11:15:00', 'Vital'),
('log515', 'user015', 'device015', 1, '2024-10-15 11:30:00', 'Vital'),
('log516', 'user016', 'device016', 1, '2024-10-16 11:45:00', 'Vital'),
('log517', 'user017', 'device017', 1, '2024-10-17 12:00:00', 'Vital'),
('log518', 'user018', 'device018', 1, '2024-10-18 12:15:00', 'Vital'),
('log519', 'user019', 'device019', 1, '2024-10-19 12:30:00', 'Vital'),
('log520', 'user020', 'device020', 1, '2024-10-20 12:45:00', 'Vital');
...
INSERT INTO goal (goal_list_id, google_id, move_minute_goal, step_goal, heart_point_goal) VALUES
('goal001', 'user001', 30, 10000, 50),
('goal002', 'user002', 45, 12000, 60),
('goal003', 'user003', 25, 8000, 40),
('goal004', 'user004', 30, 10000, 50),
('goal005', 'user005', 60, 15000, 70),
('goal006', 'user006', 35, 9000, 45),
('goal007', 'user007', 50, 11000, 55),
('goal008', 'user008', 40, 9500, 50),
('goal009', 'user009', 55, 13000, 65),
('goal010', 'user010', 20, 8500, 35),
('goal011', 'user011', 45, 12000, 60),
('goal012', 'user012', 30, 10000, 50),
('goal013', 'user013', 50, 11500, 55),
('goal014', 'user014', 35, 9000, 45),
('goal015', 'user015', 30, 10000, 50),
('goal016', 'user016', 50, 11000, 55),
('goal017', 'user017', 40, 9500, 50),
('goal018', 'user018', 60, 15000, 70),
('goal019', 'user019', 55, 13000, 65),
('goal020', 'user020', 25, 8000, 40);


INSERT INTO health_log (health_log_id, google_id, device_id, sequence_number, time_stamp, log_type) VALUES
-- Profile user001
('hl001', 'user001', 'device001', 1, '2024-10-01 08:00:00', 'activity'),
('hl002', 'user001', 'device001', 1, '2024-10-01 08:30:00', 'activity'),
('hl003', 'user001', 'device001', 1, '2024-10-01 09:00:00', 'activity'),
('hl004', 'user001', 'device001', 1, '2024-10-01 10:00:00', 'activity'),
('hl005', 'user001', 'device001', 1, '2024-10-01 11:00:00', 'activity'),

-- Profile user002
('hl006', 'user002', 'device002', 1, '2024-10-02 08:00:00', 'activity'),
('hl007', 'user002', 'device002', 1, '2024-10-02 08:30:00', 'activity'),
('hl008', 'user002', 'device002', 1, '2024-10-02 09:00:00', 'activity'),
('hl009', 'user002', 'device002', 1, '2024-10-02 10:00:00', 'activity'),
('hl010', 'user002', 'device002', 1, '2024-10-02 11:00:00', 'activity'),

-- Profile user003
('hl011', 'user003', 'device003', 1, '2024-10-03 08:00:00', 'activity'),
('hl012', 'user003', 'device003', 1, '2024-10-03 08:30:00', 'activity'),
('hl013', 'user003', 'device003', 1, '2024-10-03 09:00:00', 'activity'),
('hl014', 'user003', 'device003', 1, '2024-10-03 10:00:00', 'activity'),
('hl015', 'user003', 'device003', 1, '2024-10-03 11:00:00', 'activity'),

-- Profile user004
('hl016', 'user004', 'device004', 1, '2024-10-04 08:00:00', 'activity'),
('hl017', 'user004', 'device004', 1, '2024-10-04 08:30:00', 'activity'),
('hl018', 'user004', 'device004', 1, '2024-10-04 09:00:00', 'activity'),
('hl019', 'user004', 'device004', 1, '2024-10-04 10:00:00', 'activity'),
('hl020', 'user004', 'device004', 1, '2024-10-04 11:00:00', 'activity'),

-- Profile user005
('hl021', 'user005', 'device005', 1, '2024-10-05 08:00:00', 'activity'),
('hl022', 'user005', 'device005', 1, '2024-10-05 08:30:00', 'activity'),
('hl023', 'user005', 'device005', 1, '2024-10-05 09:00:00', 'activity'),
('hl024', 'user005', 'device005', 1, '2024-10-05 10:00:00', 'activity'),
('hl025', 'user005', 'device005', 1, '2024-10-05 11:00:00', 'activity'),

-- Profile user006
('hl026', 'user006', 'device006', 1, '2024-10-06 08:00:00', 'activity'),
('hl027', 'user006', 'device006', 1, '2024-10-06 08:30:00', 'activity'),
('hl028', 'user006', 'device006', 1, '2024-10-06 09:00:00', 'activity'),
('hl029', 'user006', 'device006', 1, '2024-10-06 10:00:00', 'activity'),
('hl030', 'user006', 'device006', 1, '2024-10-06 11:00:00', 'activity'),

-- Profile user007
('hl031', 'user007', 'device007', 1, '2024-10-07 08:00:00', 'activity'),
('hl032', 'user007', 'device007', 1, '2024-10-07 08:30:00', 'activity'),
('hl033', 'user007', 'device007', 1, '2024-10-07 09:00:00', 'activity'),
('hl034', 'user007', 'device007', 1, '2024-10-07 10:00:00', 'activity'),
('hl035', 'user007', 'device007', 1, '2024-10-07 11:00:00', 'activity'),

-- Profile user008
('hl036', 'user008', 'device008', 1, '2024-10-08 08:00:00', 'activity'),
('hl037', 'user008', 'device008', 1, '2024-10-08 08:30:00', 'activity'),
('hl038', 'user008', 'device008', 1, '2024-10-08 09:00:00', 'activity'),
('hl039', 'user008', 'device008', 1, '2024-10-08 10:00:00', 'activity'),
('hl040', 'user008', 'device008', 1, '2024-10-08 11:00:00', 'activity'),

-- Profile user009
('hl041', 'user009', 'device009', 1, '2024-10-09 08:00:00', 'activity'),
('hl042', 'user009', 'device009', 1, '2024-10-09 08:30:00', 'activity'),
('hl043', 'user009', 'device009', 1, '2024-10-09 09:00:00', 'activity'),
('hl044', 'user009', 'device009', 1, '2024-10-09 10:00:00', 'activity'),
('hl045', 'user009', 'device009', 1, '2024-10-09 11:00:00', 'activity'),

-- Profile user010
('hl046', 'user010', 'device010', 1, '2024-10-10 08:00:00', 'activity'),
('hl047', 'user010', 'device010', 1, '2024-10-10 08:30:00', 'activity'),
('hl048', 'user010', 'device010', 1, '2024-10-10 09:00:00', 'activity'),
('hl049', 'user010', 'device010', 1, '2024-10-10 10:00:00', 'activity'),
('hl050', 'user010', 'device010', 1, '2024-10-10 11:00:00', 'activity'),

-- Profile user011
('hl051', 'user011', 'device011', 1, '2024-10-11 08:00:00', 'activity'),
('hl052', 'user011', 'device011', 1, '2024-10-11 08:30:00', 'activity'),
('hl053', 'user011', 'device011', 1, '2024-10-11 09:00:00', 'activity'),
('hl054', 'user011', 'device011', 1, '2024-10-11 10:00:00', 'activity'),
('hl055', 'user011', 'device011', 1, '2024-10-11 11:00:00', 'activity'),

-- Profile user012
('hl056', 'user012', 'device012', 1, '2024-10-12 08:00:00', 'activity'),
('hl057', 'user012', 'device012', 1, '2024-10-12 08:30:00', 'activity'),
('hl058', 'user012', 'device012', 1, '2024-10-12 09:00:00', 'activity'),
('hl059', 'user012', 'device012', 1, '2024-10-12 10:00:00', 'activity'),
('hl060', 'user012', 'device012', 1, '2024-10-12 11:00:00', 'activity'),

-- Profile user013
('hl061', 'user013', 'device013', 1, '2024-10-13 08:00:00', 'activity'),
('hl062', 'user013', 'device013', 1, '2024-10-13 08:30:00', 'activity'),
('hl063', 'user013', 'device013', 1, '2024-10-13 09:00:00', 'activity'),
('hl064', 'user013', 'device013', 1, '2024-10-13 10:00:00', 'activity'),
('hl065', 'user013', 'device013', 1, '2024-10-13 11:00:00', 'activity'),

-- Profile user014
('hl066', 'user014', 'device014', 1, '2024-10-14 08:00:00', 'activity'),
('hl067', 'user014', 'device014', 1, '2024-10-14 08:30:00', 'activity'),
('hl068', 'user014', 'device014', 1, '2024-10-14 09:00:00', 'activity'),
('hl069', 'user014', 'device014', 1, '2024-10-14 10:00:00', 'activity'),
('hl070', 'user014', 'device014', 1, '2024-10-14 11:00:00', 'activity'),

-- Profile user015
('hl071', 'user015', 'device015', 1, '2024-10-15 08:00:00', 'activity'),
('hl072', 'user015', 'device015', 1, '2024-10-15 08:30:00', 'activity'),
('hl073', 'user015', 'device015', 1, '2024-10-15 09:00:00', 'activity'),
('hl074', 'user015', 'device015', 1, '2024-10-15 10:00:00', 'activity'),
('hl075', 'user015', 'device015', 1, '2024-10-15 11:00:00', 'activity'),

-- Profile user016
('hl076', 'user016', 'device016', 1, '2024-10-16 08:00:00', 'activity'),
('hl077', 'user016', 'device016', 1, '2024-10-16 08:30:00', 'activity'),
('hl078', 'user016', 'device016', 1, '2024-10-16 09:00:00', 'activity'),
('hl079', 'user016', 'device016', 1, '2024-10-16 10:00:00', 'activity'),
('hl080', 'user016', 'device016', 1, '2024-10-16 11:00:00', 'activity'),

-- Profile user017
('hl081', 'user017', 'device017', 1, '2024-10-17 08:00:00', 'activity'),
('hl082', 'user017', 'device017', 1, '2024-10-17 08:30:00', 'activity'),
('hl083', 'user017', 'device017', 1, '2024-10-17 09:00:00', 'activity'),
('hl084', 'user017', 'device017', 1, '2024-10-17 10:00:00', 'activity'),
('hl085', 'user017', 'device017', 1, '2024-10-17 11:00:00', 'activity'),

-- Profile user018
('hl086', 'user018', 'device018', 1, '2024-10-18 08:00:00', 'activity'),
('hl087', 'user018', 'device018', 1, '2024-10-18 08:30:00', 'activity'),
('hl088', 'user018', 'device018', 1, '2024-10-18 09:00:00', 'activity'),
('hl089', 'user018', 'device018', 1, '2024-10-18 10:00:00', 'activity'),
('hl090', 'user018', 'device018', 1, '2024-10-18 11:00:00', 'activity'),

-- Profile user019
('hl091', 'user019', 'device019', 1, '2024-10-19 08:00:00', 'activity'),
('hl092', 'user019', 'device019', 1, '2024-10-19 08:30:00', 'activity'),
('hl093', 'user019', 'device019', 1, '2024-10-19 09:00:00', 'activity'),
('hl094', 'user019', 'device019', 1, '2024-10-19 10:00:00', 'activity'),
('hl095', 'user019', 'device019', 1, '2024-10-19 11:00:00', 'activity'),

-- Profile user020
('hl096', 'user020', 'device020', 1, '2024-10-20 08:00:00', 'activity'),
('hl097', 'user020', 'device020', 1, '2024-10-20 08:30:00', 'activity'),
('hl098', 'user020', 'device020', 1, '2024-10-20 09:00:00', 'activity'),
('hl099', 'user020', 'device020', 1, '2024-10-20 10:00:00', 'activity'),
('hl100', 'user020', 'device020', 1, '2024-10-20 11:00:00', 'activity');
